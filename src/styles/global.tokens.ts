...
export const stylesTokensCore = {
  ...
  '--em-core-border-radius--050': '.125rem',
  '--em-core-border-radius--100': '.25rem',
  '--em-core-border-radius--150': '.375rem',
  '--em-core-border-radius--200': '.5rem',
  '--em-core-border-radius--300': '.75rem',
  '--em-core-border-radius--400': '2rem',
  '--em-core-border-radius--500': '624.9375rem',
  '--em-core-border-width--000': '0rem',
  '--em-core-border-width--025': '.0625rem',
  '--em-core-border-width--050': '.125rem',
  '--em-core-border-width--100': '.25rem',
  ...
  '--em-core-font-size--sm': '.875rem',
  '--em-core-font-size--xl': '1.25rem',
  '--em-core-font-size--xs': '.75rem',
  ...
  '--em-core-line-height--sm': '.875rem',
  '--em-core-line-height--xl': '2.375rem',
  '--em-core-shadow-blur': '2.5rem',
  '--em-core-shadow-color': '#21212940',
  '--em-core-shadow-position-x': '0rem',
  '--em-core-shadow-position-y': '.0625rem',
  '--em-core-shadow-spread': '0rem',
  '--em-core-size--0000': '0rem',
  '--em-core-size--0050': '.125rem',
  '--em-core-size--0100': '.25rem',
  '--em-core-size--0150': '.375rem',
  '--em-core-size--0200': '.5rem',
  '--em-core-size--0300': '.75rem',
  ...
  '--em-core-spacing--0050': '.125rem',
  '--em-core-spacing--0100': '.25rem',
  '--em-core-spacing--0150': '.375rem',
  '--em-core-spacing--0200': '.5rem',
  '--em-core-spacing--0300': '.75rem',
...
export const stylesTokensComponents = {
  ...
  '--em-chart-grid-line-width--medium': '.125rem',
  '--em-chart-grid-line-width--thick': '.25rem',
  '--em-chart-grid-line-width--thin': '.0625rem',
  '--em-chart-grid-tick-length': 'var(--em-core-size--0100)',
  '--em-chart-grid-tick-width': '.0625rem',
  ...
  '--em-kpichart-number-font-size--min': '.75rem',
  ...
  '--em-linechart-line-width': '.125rem',
  ...
  '--em-markdown-hr-border-width': '.0625rem',
  ...
  '--em-markdown-options-border-width': '.0625rem',
  ...
  '--em-selectfield-content-opacity--loading': '.5',
  ...
  '--em-tablechart-border-width': '.0625rem',
  ...
  '--em-charttabs-item-opacity': '.5 /* from remarkable-pro */',
  ...
  '--em-charttabs-scroll-button-width': '28px',
};
