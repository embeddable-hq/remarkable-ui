...
export const stylesTokensComponents = {
  ...
  '--em-card-shadow-blur': 'var(--em-core-shadow-blur)',
  '--em-card-shadow-color': 'none',
  '--em-card-shadow-position-x': 'var(--em-core-shadow-position-x)',
  '--em-card-shadow-position-y': 'var(--em-core-shadow-position-y)',
  '--em-card-shadow-spread': 'var(--em-core-shadow-spread)',
