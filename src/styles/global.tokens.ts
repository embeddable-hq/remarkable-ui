...
export const stylesTokensComponents = {
  ...
  '--em-dialog-backdrop-background': 'var(--em-overlay-background)',
  '--em-dialog-height': 'calc(100% - 2 * var(--em-core-spacing--0800))',
  '--em-dialog-max-height': 'none',
  '--em-dialog-max-width': 'none',
  '--em-dialog-width': 'calc(100% - 2 * var(--em-core-spacing--0800))',
