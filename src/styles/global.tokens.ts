...
export const stylesTokensComponents = {
  ...
  '--em-scatterchart-border-width': 'var(--em-core-border-width--025, 1px)',
  '--em-scatterchart-null-opacity': '0.3',
  '--em-scatterchart-opacity': '0.8',
  '--em-scatterchart-point-radius': 'var(--em-core-border-radius--150, 6px)',
