...
export const stylesTokensComponents = {
  ...
  '--em-tabs-background': 'transparent',
  '--em-tabs-padding': 'var(--em-core-spacing--0000)',
  '--em-tabs-gap': 'var(--em-core-spacing--0300)',
  '--em-tabs-justify-content': 'flex-start',
  '--em-tabs-margin-bottom': 'var(--em-core-spacing--0400)',
  '--em-tabs-border-radius': 'var(--em-core-border-radius--000)',
  '--em-tabs-border-width': 'var(--em-core-border-width--000)',
  '--em-tabs-border-color': 'transparent',
  '--em-tabs-rail-width': 'var(--em-core-border-width--025)',
  '--em-tabs-rail-color': 'var(--em-sem-background--subtle)',
  '--em-tabs-item-padding': 'var(--em-core-spacing--0200) var(--em-core-spacing--0300)',
  '--em-tabs-item-gap': 'var(--em-core-spacing--0200)',
  '--em-tabs-item-background': 'transparent',
  '--em-tabs-item-color': 'var(--em-sem-text--muted)',
  '--em-tabs-item-opacity': '1',
  '--em-tabs-item-border-radius': 'var(--em-core-border-radius--000)',
  '--em-tabs-item-border-width': 'var(--em-core-border-width--000)',
  '--em-tabs-item-border-color': 'transparent',
  '--em-tabs-item-font-family': 'var(--em-core-font-family--base)',
  '--em-tabs-item-font-size': 'var(--em-core-font-size--sm)',
  '--em-tabs-item-font-weight': 'var(--em-core-font-weight--regular)',
  '--em-tabs-item-line-height': 'var(--em-core-line-height--md)',
  '--em-tabs-item-letter-spacing': 'normal',
  '--em-tabs-item-text-transform': 'none',
  '--em-tabs-item-background--hover': 'var(--em-sem-background--light)',
  '--em-tabs-item-color--hover': 'var(--em-sem-text)',
  '--em-tabs-item-border-color--hover': 'transparent',
  '--em-tabs-item-opacity--hover': '1',
  '--em-tabs-item-background--active': 'transparent',
  '--em-tabs-item-color--active': 'var(--em-sem-text)',
  '--em-tabs-item-border-color--active': 'transparent',
  '--em-tabs-item-font-weight--active': 'var(--em-core-font-weight--medium)',
  '--em-tabs-item-opacity--active': '1',
  '--em-tabs-item-color--disabled': 'var(--em-sem-text--subtle)',
  '--em-tabs-item-opacity--disabled': '1',
  '--em-tabs-item-outline-color--focus': 'var(--em-sem-text)',
  '--em-tabs-item-outline-width--focus': 'var(--em-core-border-width--050)',
  '--em-tabs-item-outline-offset--focus': 'var(--em-core-spacing--0050)',
  '--em-tabs-indicator-height': 'var(--em-core-border-width--050)',
  '--em-tabs-indicator-color': 'var(--em-sem-text)',
  '--em-tabs-indicator-border-radius': 'var(--em-core-border-radius--000)',
  '--em-tabs-indicator-offset': 'calc(-1 * var(--em-core-border-width--025))',
  '--em-tabs-transition-duration': 'var(--em-core-motion-duration--fast)',
  '--em-tabs-transition-easing': 'var(--em-core-motion-easing--in-out)',
};
